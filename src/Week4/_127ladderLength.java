...
public class _127ladderLength {
    public int ladderLength(String beginWord, String endWord, List<String> wordList) {
        //第一步：先将wordlist放到HashSet里，便于判断某个单词是否在wordlist里
        ...
        //第二步：图的广度优先遍历，必须使用队列和表示是否访问过的visited Hash表
        ...
        while(!queue.isEmpty()) {
            ...
            for(int i = 0; i< currentSize;i++) {
                ...
                //如果当前currentWord能够修改1个字符就能与endWord相同，则返回step+1
    ...
    /**
     * 尝试对currentWord修改每一个字符，看看是否能与endWord匹配
     * @param currentWord
     * @param endWord
     * @param queue
     * @param visited
